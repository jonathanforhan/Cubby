...
export const LoginModal = (props) => {
  return (
    <>
    <div className="LoginModal h-[23rem] lg:h-[28rem] 2xl:h-[30rem] w-3/4 md:w-5/12 lg:w-1/3 2xl:w-1/4 bg-white m-auto rounded-lg pb-8">
      <div className="LoginInput grid h-[70%] pt-8 lg:pt-10 px-5 lg:px-10">
        <div className="LoginTitle font-lora text-center text-[2rem] lg:text-[2.3rem] 2xl:text-[2.8rem]">Member Login</div>
