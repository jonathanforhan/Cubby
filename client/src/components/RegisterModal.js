...
export const RegisterModal = (props) => {
  return (
  <>
    <div className="SignUpModal h-[38rem] lg:h-[40rem] 2xl:h-[42rem] w-3/4 md:w-5/12 lg:w-1/3 2xl:w-1/4 bg-white m-auto rounded-lg pb-8">
      <div className="SignUpInput grid h-[85%] pt-8 lg:pt-10 px-5 lg:px-10">
        <div className="SignUpTitle font-lora text-center text-[2.3rem] lg:text-[2.4rem] xl:text-[2.6rem] 2xl:text-[2.7rem]">Cubby Sign Up</div>
