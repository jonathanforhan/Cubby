    ...
    return (
      <>
        <nav className="HomeNav w-full h-[3.2rem] bg-violet-200 px-[5vw] flex">
          ...
          <Link to='/cubbies' className="CubbiesLink text-[1.2rem] my-auto mx-[1.2rem] hover:underline">Cubbies</Link>
          <Link to='/' className="PlansLink text-[1.2rem] my-auto mx-[1.2rem] hover:underline">Plans</Link>
          <Link to='/' className="FeaturesLink text-[1.2rem] my-auto mx-[1.2rem] hover:underline">Features</Link>
          <HamburgerMenu url={url} alt={alt}/> 
        </nav>
      </>
    )
